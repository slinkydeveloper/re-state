...
- [x] 2.1. Create Idealista scraper utility
...
- [x] 2.2. Create Immobiliare scraper utility
...
- [x] 3.1. Create ResearchTracker Virtual Object
...
- [x] 3.2. Register ResearchTracker in endpoint
...
- [x] 4.1. Create research management API routes
...
- [x] 4.2. Create ads management API routes
...
- [x] 4.3. Create questions API routes
...
- [x] 5.2. Create research page layout
...
- [x] 5.3. Implement ad submission functionality
...
- [x] 5.4. Implement status and notes update functionality
  - File: `app/research/[name]/page.tsx` (modify existing)
...
- [x] 5.5. Implement Q&A functionality
  - File: `app/research/[name]/page.tsx` (modify existing)
...
- [x] 5.6. Add table filtering and sorting
  - File: `app/research/[name]/page.tsx` (modify existing)
...
- [x] 6.1. Create unit tests for ResearchTracker Virtual Object
...
- [x] 6.2. Add basic error handling improvements
